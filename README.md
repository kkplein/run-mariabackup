Is script is much simpler than all the other script I found: It creates a FULL backup, upon which all subsequent incrementals are based. (so: no incremental based on another incremental)
